...
public class PreferenceManagerCompat {
	...
	/**
	 * Interface definition for pf_preference_list_fragment callback to be invoked when pf_preference_list_fragment
	 * {@link Preference} in the hierarchy rooted at this {@link PreferenceScreen} is
	 * clicked.
	 */
	interface OnPreferenceTreeClickListener {
		/**
		 * Called when pf_preference_list_fragment preference in the tree rooted at this
	...
	/**
	 * Sets the callback to be invoked when pf_preference_list_fragment {@link Preference} in the
	...
	/**
	 * Inflates pf_preference_list_fragment preference hierarchy from the preference hierarchies of
	 * {@link Activity Activities} that match the given {@link Intent}. An
	 * {@link Activity} defines its preference hierarchy with meta-data using
	 * the {@link #METADATA_KEY_PREFERENCES} key.
	 * <p>
	 * If pf_preference_list_fragment preference hierarchy is given, the new preference hierarchies will
	 * be merged in.
	 *
	...
	/**
	 * Inflates pf_preference_list_fragment preference hierarchy from XML. If pf_preference_list_fragment preference hierarchy is
	...
	/**
	 * Called by the {@link PreferenceManager} to dispatch pf_preference_list_fragment subactivity result.
	 */
