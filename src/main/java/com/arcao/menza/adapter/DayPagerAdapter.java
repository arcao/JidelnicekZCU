...
import com.arcao.menza.fragment.DayMenuListFragment;
...
public class DayPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        Fragment fragment = new DayMenuListFragment();

        Bundle args = new Bundle();
        args.putInt(DayMenuListFragment.ARG_DAY_ID, position);
        args.putInt(DayMenuListFragment.ARG_MENZA_ID, menzaId);
    ...
    public int getItemPosition(Object object) {
        if (object instanceof UpdateableFragment) {
            ...
            fragment.getArguments().putInt(DayMenuListFragment.ARG_MENZA_ID, menzaId);
            fragment.update();
        }
    ...
    public void updateMenzaId(int id) {
        this.menzaId = id;
